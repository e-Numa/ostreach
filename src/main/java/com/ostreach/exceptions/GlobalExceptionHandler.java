...
import com.ostreach.entities.model.ErrorDetail;
import com.ostreach.payload.response.ApiResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<ErrorDetail>> handleChangeDefaultPasswordException(final ChangePasswordException exception){
        ErrorDetail errorDetail = ErrorDetail.builder()
                .message(exception.getMessage())
